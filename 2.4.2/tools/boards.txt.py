...
# Customize default boardlist here.
#
# Use this to reduce board menu list to a list of the boards you have.
# Update boardlist below and run:
#
#   to view the results of your changes:
#       ./tools/boards.txt.py --boards --boardlist
#
...
# in boardlist, and replaces boards.local.txt with one that only contains
# the boards in boardlist.
#       ./tools/boards.txt.py --boardsgen --xboardlist
#       ./tools/boards.txt.py --boardslocalgen --boardlist
...
boards = collections.OrderedDict([
    ...
    ( 'espurna', {
        'name': 'ESPurna for ESP8266 based Modules',
        'opts': {
            '.build.board': 'ESP8266_GENERIC',
            '.menu.FlashMode.dout': 'DOUT',
            '.menu.BoardModel.kmcSmartPlug': 'KMC WiFi Smart Plug (70011)',
            '.menu.BoardModel.kmcSmartPlug.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DKMC_70011',
            '.menu.BoardModel.kmcSmartPlug.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffBasic': 'ITEAD Sonoff Basic',
            '.menu.BoardModel.sonoffBasic.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_BASIC',
            '.menu.BoardModel.sonoffBasic.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffRF': 'ITEAD Sonoff RF',
            '.menu.BoardModel.sonoffRF.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_RF',
            '.menu.BoardModel.sonoffRF.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffTH': 'ITEAD Sonoff TH',
            '.menu.BoardModel.sonoffTH.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_TH',
            '.menu.BoardModel.sonoffTH.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffSV': 'ITEAD Sonoff SV',
            '.menu.BoardModel.sonoffSV.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_SV',
            '.menu.BoardModel.sonoffSV.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffSlampher': 'ITEAD Slampher',
            '.menu.BoardModel.sonoffSlampher.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SLAMPHER',
            '.menu.BoardModel.sonoffSlampher.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffS20': 'ITEAD S20 Smart Socket',
            '.menu.BoardModel.sonoffS20.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_S20',
            '.menu.BoardModel.sonoffS20.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffPOW': 'ITEAD Sonoff POW',
            '.menu.BoardModel.sonoffPOW.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_POW',
            '.menu.BoardModel.sonoffPOW.build.led': '-DLED_BUILTIN=15',
            '.menu.BoardModel.sonoffDual': 'ITEAD Sonoff Dual',
            '.menu.BoardModel.sonoffDual.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_DUAL',
            '.menu.BoardModel.sonoffDual.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffDualR2': 'ITEAD Sonoff Dual R2',
            '.menu.BoardModel.sonoffDualR2.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_DUAL_R2',
            '.menu.BoardModel.sonoffDualR2.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoff1CHInching': 'ITEAD 1CH Inching',
            '.menu.BoardModel.sonoff1CHInching.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_1CH_INCHING',
            '.menu.BoardModel.sonoff1CHInching.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.iteadMotor': 'ITEAD Motor',
            '.menu.BoardModel.iteadMotor.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_MOTOR',
            '.menu.BoardModel.iteadMotor.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffBNSZ01': 'ITEAD Sonoff BNSZ01',
            '.menu.BoardModel.sonoffBNSZ01.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_BNSZ01',
            '.menu.BoardModel.sonoffBNSZ01.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffRFBridge': 'ITEAD Sonoff RF Bridge',
            '.menu.BoardModel.sonoffRFBridge.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_RFBRIDGE',
            '.menu.BoardModel.sonoffRFBridge.build.led': '-DLED_BUILTIN=13',
            '.menu.BoardModel.sonoffLED': 'ITEAD Sonoff LED',
            '.menu.BoardModel.sonoffLED.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_LED',
            '.menu.BoardModel.sonoffLED.build.led': '-DLED_BUILTIN=13',
            },
        'macro': [
            'resetmethod_menu_extra',
            'resetmethod_menu',
            ...
            'flashmode_menu',
            '1M', '2M', '4M', '8M', '16M',
            'espurna_options_menu',
            'my_project_flags_menu',
            ],
        'desc': [ 'Build tweaks for building ESPurna for ESP8266 based devices. Devices from ITEAD and KMC.',
                  'Use Model list to make selection.',
                  'See https://github.com/xoseperez/espurna/wiki for details on the ESPurna project.' ],
    }),
    ( 'espurnakmc', {
        'name': 'ESPurna for KMC 70011',
        'opts': {
            '.build.board': 'ESP8266_GENERIC',
            '.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DKMC_70011',
            '.build.led': '-DLED_BUILTIN=13',
            },
        'macro': [
            'resetmethod_menu_extra',
            'resetmethod_menu',
        ...
        'desc': [ 'Build tweaks for building ESPurna for ESP8266 based device by KMC.',
                  'See https://github.com/xoseperez/espurna/wiki for details on the ESPurna project.' ],
    }),
    # Sonoff 4CH, Sonoff 4CH Pro, Sonoff Touch, Sonoff B1, Sonoff T1, AI-Thinker Wifi Light
    # These device are believed to be based on esp8285 which only have 1MB of flash
    # thus build.board=ESP8266_ESP01
    ( 'espurna85', {
        'name': 'ESPurna for ESP8285 based Modules',
        'opts': {
            '.build.board': 'ESP8266_ESP01',
            '.menu.FlashMode.dout': 'DOUT',
            '.menu.led.13': '13',
            ...
            '.menu.BoardModel.sonoff4CHPro.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_4CH_PRO',
            '.menu.BoardModel.sonoffTouch': 'ITEAD Sonoff Touch',
            '.menu.BoardModel.sonoffTouch.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_TOUCH',
            '.menu.BoardModel.sonoffB1': 'ITEAD Sonoff B1',
            '.menu.BoardModel.sonoffB1.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_B1',
            '.menu.BoardModel.sonoffT11CH': 'ITEAD Sonoff T1 1CH',
            '.menu.BoardModel.sonoffT11CH.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_T1_1CH',
            '.menu.BoardModel.sonoffT12CH': 'ITEAD Sonoff T1 2CH',
            '.menu.BoardModel.sonoffT12CH.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_T1_2CH',
            '.menu.BoardModel.sonoffT13CH': 'ITEAD Sonoff T1 3CH',
            '.menu.BoardModel.sonoffT13CH.build.extra_flags': '-DESP8266 -DMQTT_MAX_PACKET_SIZE=400 -DESPURNA -DITEAD_SONOFF_T1_3CH',
            '.menu.BoardModel.AIThinkerWifiLight': 'AI-Thinker Wifi Light',
            '.menu.BoardModel.AIThinkerWifiLight.build.extra_flags': '-DESP8266 -DAITHINKER_AI_LIGHT',
            },
        'macro': [
            'resetmethod_menu_extra',
            'resetmethod_menu',
        ...
        'desc': [ 'Build tweaks for building ESPurna for ESP8285 based devices w/1MB flash.',
                  'Use Model list to make selection, ITEAD: Sonoff 4CH, Sonoff 4CH Pro, Sonoff Touch, Sonoff B1, and Sonoff T1, and AI-Thinker: Wifi Light.',
                  'See https://github.com/xoseperez/espurna/wiki for details on the ESPurna project.' ],
    })
    ])
...
macros = {
    ...
    ####################### Some ESPurna build options

    'espurna_options_menu': collections.OrderedDict([
        ( '.menu.espurna_ha.turnOnHaDomoticz', 'Domoticz' ),
        ( '.menu.espurna_ha.turnOnHaDomoticz.build.espurna_ha_flags', '-DHOMEASSISTANT_SUPPORT=0 -DTHINGSPEAK_SUPPORT=0 -DDOMOTICZ_SUPPORT=1' ),
        ( '.menu.espurna_ha.turnOnHaHomeAssistant', 'Home Assistant' ),
        ( '.menu.espurna_ha.turnOnHaHomeAssistant.build.espurna_ha_flags', '-DHOMEASSISTANT_SUPPORT=1 -DTHINGSPEAK_SUPPORT=0 -DDOMOTICZ_SUPPORT=0' ),
        ( '.menu.espurna_ha.turnOnHaThinkspeak', 'Thinkspeak' ),
        ( '.menu.espurna_ha.turnOnHaThinkspeak.build.espurna_ha_flags', '-DHOMEASSISTANT_SUPPORT=0 -DTHINGSPEAK_SUPPORT=1 -DDOMOTICZ_SUPPORT=0' ),
        ( '.menu.espurna_ha.none', 'none' ),
        ( '.menu.espurna_flags.none', 'none' ),
        ( '.menu.espurna_flags.i2cSupport', 'I2C Support' ),
        ( '.menu.espurna_flags.i2cSupport.build.espurna_flags', '-DI2C_SUPPORT=1' ),
        ( '.menu.espurna_flags.dallasSupport', 'Dallas Support' ),
        ( '.menu.espurna_flags.dallasSupport.build.espurna_flags', '-DDALLAS_SUPPORT=1' ),
        ( '.menu.espurna_flags.dhtSupport', 'DHT Support' ),
        ( '.menu.espurna_flags.dhtSupport.build.espurna_flags', '-DDHT_SUPPORT=1' ),
        ( '.menu.espurna_flags.hlw9012Support', 'HLW9012 Support' ),
        ( '.menu.espurna_flags.hlw9012Support.build.espurna_flags', '-DHLW8012_SUPPORT=1' ),
        ]),

    ######################## Discovery Methods Menu

    'my_project_flags_menu': collections.OrderedDict([
        ( '.menu.my_project_flags.none', 'none' ),
        ( '.menu.my_project_flags.nameresolv1', 'LLMNR Support' ),
        ( '.menu.my_project_flags.nameresolv1.build.my_project_flags', '-DLLMNR_SUPPORT' ),
        ( '.menu.my_project_flags.nameresolv2', 'NetBIOS Support' ),
        ( '.menu.my_project_flags.nameresolv2.build.my_project_flags', '-DNETBIOS_SUPPORT' ),
        ( '.menu.my_project_flags.nameresolv3', 'LLMNR and NetBIOS Support' ),
        ( '.menu.my_project_flags.nameresolv3.build.my_project_flags', '-DLLMNR_SUPPORT -DNETBIOS_SUPPORT' ),
        ])
    }
    ...
    if boardsgen:
        ...
        if boardslocalgen:
            ...
            if os.path.isfile("boards.local.txt"):
                if os.path.isfile("boards.local.txt.bak"):
                    os.remove("boards.local.txt.bak")
                os.rename("boards.local.txt", "boards.local.txt.bak")
...
# Customized some defaults
    print '# From Customized boards.txt.py'
    if boardlistopt or excludeboards:
        out = ""
        for a in sys.argv:
            out += " " + a
        print "# Abbreviated boards.txt created by:" + out
        out = ""
        for a in boardlist:
            out += " " + "--board=" + a
 ...
 # I added these three for ESPurna- mjh
    print 'menu.my_project_flags=Project Build Flags'
    print 'menu.espurna_ha=HA Platform'
    print 'menu.espurna_flags=ESPurna Build Flags'
    print ''
...
def usage (name,ret):
    ...
    print " --boardlist      - create an abbreviated boards.txt (use with --board b ...)"
    print " --xboardlist     - use --board b to build a board exclude list"
    print "                    (For --boardlist or --xboardlist use only one)"
    ...
    print "                    (always overwites boards.local.txt.bak with old boards.local.txt)"
    ...
    if boardcount == 0:
        ...
        for b in boardlist:
            out += b + ' '
        print "default board names for --boardlist or --xboardlist option:", out
    print ""
...
boardsgen = False
boardsshow = False
# # Customize here. Update this list for a short default set of boards for boardlistopt
# boardlist = [ 'generic', 'esp8285', 'huzzah', 'sonoff', 'espurna', 'espurna85' ]
boardlistopt = False
excludeboardlist = []
excludeboards = False
boardcount = 0
...
try:
    opts, args = getopt.getopt(sys.argv[1:], "h",
        [ "help", "lwip=", "led=", "speed=", "board=", "customspeed=", "nofloat",
          "noextra4kheap", "allowWPS", "boardlist", "boardslocalgen", "xboardlist", "board+=",
...
for o, a in opts:
    ...
    if boardlistopt and excludeboards:
        print "Specify either --boardlist or --xboardlist, not both."
        usage(sys.argv[0], 0)
