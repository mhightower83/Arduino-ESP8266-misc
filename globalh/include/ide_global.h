...
//
// compiler.c.extra_flags=-include "{custom.global.path}\ide_global.h" -include "{build.path}/sketch/global.h"
// compiler.S.extra_flags=-include "{custom.global.path}\ide_global.h" -include "{build.path}/sketch/global.h"
// compiler.cpp.extra_flags=-include "{custom.global.path}\ide_global.h" -include "{build.path}/sketch/global.h"
