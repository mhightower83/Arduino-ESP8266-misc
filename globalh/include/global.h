 ...
 *
 * No other defines should be placed here. Only the defines you would like
 * to have in every module that is built for this sketch.
 *
 * For this file to work there are additions that are needed in platform.local.txt.
 *
 */
